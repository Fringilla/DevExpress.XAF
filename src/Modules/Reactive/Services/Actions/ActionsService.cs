...
namespace Xpand.XAF.Modules.Reactive.Services.Actions{
    ...
    public static partial class ActionsService{
        ...
        public static IObservable<TAction> WhenActionActivated<TAction>(this IObservable<TAction> source)where TAction : ActionBase => source.SelectMany(a => a.WhenActionActivated());
